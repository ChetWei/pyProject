...
class User(models.Model):
    ...
    number = models.CharField(verbose_name='qq账号',primary_key=True,null=False,blank=False,max_length=16)
    ...
    ban = models.BooleanField(verbose_name='是否禁用',default=False)



"""延时授权码表"""
class AuthorizationCode(models.Model):
    code = models.CharField(verbose_name='延时授权码',primary_key=True,null=False,blank=False,max_length=32)
    duration = models.IntegerField(verbose_name='时长',default=60)  #默认60分钟
...
class Connect(models.Model):
    ...
    # qq_number = models.CharField(verbose_name='qq账号,外键',max_length=16)
    # tea_account = models.CharField(verbose_name='tea账号,外键',max_length=8)
