$(function() {
	...
	function getE2901(str) {
		if (str.indexOf("E2901") == -1) {
			return str;
		}
		if (str.indexOf('(Third party -101)User name or password is empty.') > 0) {
			return "E9900";
		} else if (str.indexOf("(Third party -1)1|19") > 0) {
			return "E9901";
		} else if (str.indexOf("(Third party -1)1|90") > 0) {
			return "E9902";
		} else if (str.indexOf("(Third party -1)1") > 0) {
			return "E9903";
		} else if (str.indexOf("(Third party -1)99") > 0) {
			return "E9904";
		} else if (str.indexOf("(Third party -1)[Code 5]") > 0) {
			return "E9905";
		} else if (str.indexOf("(Third party -1)[Code 6|2]") > 0) {
			return "E9906";
		} else if (str.indexOf("(Third party -1)[Code 30|3]") > 0) {
			return "E9907";
		} else if (str.indexOf("(Third party -1)3|94") > 0) {
			return "E9908";
		} else if (str.indexOf("(Third party -1)[Code 3]") > 0) {
			return "E9909";
		} else if (str.indexOf("(Third party -1)5") > 0 || str.indexOf("(Third party -1)4|82") > 0) {
			return "E9910";
		} else if (str.indexOf("(Third party -1)2") > 0) {
			return "E9911";
		} else if (str.indexOf("(Third party -1)code[030]") > 0) {
			return "E9912";
		} else if (str.indexOf("(Third party -1)code[051]") > 0) {
			return "E9913";
		} else if (str.indexOf("(Third party -1)code[028]") > 0) {
			return "E9914";
		} else if (str.indexOf("(Third party -1)code[109]") > 0) {
			return "E9915";
		} else {
			return str;
		}
