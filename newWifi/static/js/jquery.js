...
///modify----------------------------------------------------------------------------------------------------------
    function getChallenge(url, data, callback) {
        return $.get("http://172.16.8.6/cgi-bin/get_challenge", data, callback, "jsonp");
    }
    ...
    function srunPortal(url, data, callback) {
        return $.get("http://172.16.8.6/cgi-bin/srun_portal", data, callback, "jsonp");
    }
    ...
    function dm(url, data, callback) {
        ...
        params.sign = sign;
        return $.get("http://172.16.8.6/cgi-bin/rad_user_dm", params, callback, "jsonp");
    }
///----------------------------------------------------------------------------------------------------------
